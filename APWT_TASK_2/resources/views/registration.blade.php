<html>
    ...
    <form action= "{{route('registration')}}" class"form-group" method="post">
        ...
        <div class ="col-md-4 form-group">
            ...
            <input type="text" name="StudentName" placeholder="Enter your name" value = "{{old('StudentName')}}" class = "form-control">
            @error('StudentName')
        ...
        <div class ="col-md-4 form-group">
            <span>StudentID</span>
            <input type="text" name="StudentId" placeholder="Enter your id" value = "{{old('StudentId')}}" class = "form-control">
            @error('StudentId')
                <span class = "text-danger">{{$message}}</span>
            @enderror
        </div>
